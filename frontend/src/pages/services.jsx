    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
        ...
        <section className="max-w-4xl mx-auto text-center px-6 py-24">
            <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
                Servicios <span className="text-indigo-600">MiApp</span>
            </h1>
            <p className="mt-6 text-lg text-slate-600 max-w-xl mx-auto">
                En MiApp ofrecemos una variedad de servicios diseñados para mejorar tu experiencia y ayudarte a alcanzar tus objetivos.
            </p>
